...
async def analyze_architecture(
    ...
    try:
        ...
        extracted_dir = archive_service.extract(temp_file.name)
        ...
        repository.save(
            ...
            overall_score=report["benchmark_result"]["overall_score"],
            report=report,
...
@infrastructure_router.post("/analyze-github")
async def analyze_github_repository(
    ...
    repo_path = github_service.clone_repository(request.repository_url)
    ...
    try:
        ...
        repository.save(
            repository_name=request.repository_url,
            overall_score=report["benchmark_result"]["overall_score"],
            report=report,
            user_id=current_user_id,
        )
