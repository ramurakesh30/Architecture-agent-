...
from backend.services.kubernetes_review_service import KubernetesReviewService
...
async def analyze_kubernetes(file: UploadFile = File(...)):

    content = await file.read()

    result = service.analyze(content.decode("utf-8"))
