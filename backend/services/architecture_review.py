...
from backend.app.agents.availability_agent import (
    AvailabilityAgent
)
...
from backend.app.agents.scalability_agent import (
    ScalabilityAgent
)
...
class ArchitectureReviewService:
    ...
    def analyze(self, request):
        ...
        self.availability_agent.analyze(
            request,
            result
        )
